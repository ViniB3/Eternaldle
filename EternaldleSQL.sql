...
DROP TABLE IF EXISTS eternaldle;
...
QUANTIDADE_DE_ARMA INT (50),
IMAGEM_URL VARCHAR(255)
);

INSERT INTO eternaldle(NOME,GENERO,CLASSE,ALCANCE,COR_CABELO,ANO_DE_LANCAMENTO,QUANTIDADE_DE_ARMA,IMAGEM_URL) VALUES
