...
characters = [
    ...
    ('Barbara','Mulher','Mago','Longo alcance','Castanho','2021',1,'https://i.imgur.com/qqzCI8Z.jpeg'),
    ...
    ('Felix','Homem','Lutador','Corpo-a-corpo','Cinza','2022',1,'https://i.imgur.com/8Ar88WP.png'),
